...
class MyFrame(wx.Frame):
    def __init__(self):
        ...
        menu=wx.Menu()
        ctrla=menu.Append(-1, "/tCtrl-A")
        ctrlc=menu.Append(-1, "/tCtrl-C")
        ctrlx=menu.Append(-1, "/tCtrl-X")
        ctrlv=menu.Append(-1, "/tCtrl-V")
        ctrls=menu.Append(-1, "/tCtrl-S")
    ...
    def getPathFile(self, Basepathfile, fileName):
        PrelimPathFile = os.path.join(Basepathfile, fileName )
        PathFile = os.path.normpath(PrelimPathFile)
        return  PathFile

        newFileName = getPathFile(Basepathfile,'icons/new.png')
        openFileName = getPathFile(Basepathfile,'icons/open.png')
        exitFileName = getPathFile(Basepathfile,'icons/exit.png')
        saveFileName = getPathFile(Basepathfile,'icons/save.png')
        saveallFileName = getPathFile(Basepathfile,'icons/saveall.png')
        backFileName = getPathFile(Basepathfile,'icons/back.png')
        goFileName = getPathFile(Basepathfile,'icons/go.png')
        clearFileName = getPathFile(Basepathfile,'icons/clear.png')

        new=wx.Image(newPathFile,wx.BITMAP_TYPE_PNG).ConvertToBitmap()
        open=wx.Image(openFileName,wx.BITMAP_TYPE_PNG).ConvertToBitmap()
        exit=wx.Image(exitFileName,wx.BITMAP_TYPE_PNG).ConvertToBitmap()
        save=wx.Image(saveFileName,wx.BITMAP_TYPE_PNG).ConvertToBitmap()
        saveall=wx.Image(saveallFileName,wx.BITMAP_TYPE_PNG).ConvertToBitmap()
        back=wx.Image(backFileName,wx.BITMAP_TYPE_PNG).ConvertToBitmap()
        go=wx.Image(goFileName,wx.BITMAP_TYPE_PNG).ConvertToBitmap()
        clear=wx.Image(clearFileName,wx.BITMAP_TYPE_PNG).ConvertToBitmap()
